...
::============================================================================
::
::   IDM Activation Script (IAS) - Tuanwara Edition
::
::   Homepage: https://github.com/tuanwara/IDM-Activation-Script
::
::   Modified by: Tuanwara
::
::============================================================================

::  To activate, run the script with "/act" parameter
set _activate=0

::  To Freeze the 30 days trial period, run the script with "/frz" parameter
set _freeze=0

::  To reset the activation and trial, run the script with "/res" parameter
set _reset=0
...
set "blank="
set "repo=https://github.com/tuanwara/IDM-Activation-Script"

::  Check Null service
sc query Null | find /i "RUNNING"
if %errorlevel% NEQ 0 (
echo:
echo Null service is not running...
ping 127.0.0.1 -n 10
)
cls
...
cls
color 0B
title  IDM Activation Script %iasver% - Tuanwara Edition
...
::========================================================================================================================================
::  Setup Colors for Tuanwara Theme
::========================================================================================================================================
...
%nceline%
echo Unable to find powershell.exe.
goto done2
)
...
%eline%
echo Script is launched from temp folder. Extract it first.
goto done2
)
)
...
reg query HKU\%_sid%\Software %nul% || (
%eline%
echo User Account SID not found.
goto done2
)
...
%eline%
echo Failed to write in Registry.
goto done2
)
...
cls
title  IDM Activation Script %iasver% - Tuanwara
if not defined terminal mode 80, 28

:: Define ASCII Art in Variables to prevent syntax errors
set "L1=    ___ ____  __  __     ___   ___ _____ _____     ___   _____ ___ ___  _  _ "
set "L2=   |_ _|   \|  \/  |    /_\ \ / /_   _|_   _|   /_\ /_   _|_ _/ _ \| \| |"
set "L3=    | || |) | |\/| |   / _ \ V /  | |   | |    / _ \  | |  | | (_) | .` |"
set "L4=   |___|___/|_|  |_|  /_/ \_\_|   |_|   |___| /_/ \_\ |_| |___\___/|_|\_|"

echo:
call :_color %_Cyan% " =============================================================================="
echo:
call :_ascii %_Green% L1
call :_ascii %_Green% L2
call :_ascii %_Green% L3
call :_ascii %_Green% L4
echo:
call :_color %_Cyan% " =============================================================================="
echo:
call :_color2 %_White% "      GitHub : " %_Yellow% "github.com/tuanwara/IDM-Activation-Script"
call :_color2 %_White% "      Author : " %_Magenta% "Tuanwara"
echo:
call :_color %_Cyan% " ------------------------------------------------------------------------------"
echo:
call :_color2 %_Yellow% "      [1] " %_White% "Activate IDM"
call :_color2 %_Yellow% "      [2] " %_White% "Freeze Trial Period"
call :_color2 %_Yellow% "      [3] " %_White% "Reset Activation / Trial"
echo:
call :_color %_Cyan% " ------------------------------------------------------------------------------"
echo:
call :_color2 %_Yellow% "      [4] " %_White% "Download IDM"
call :_color2 %_Yellow% "      [5] " %_White% "Help"
call :_color2 %_Yellow% "      [0] " %_White% "Exit"
echo:
call :_color %_Cyan% " =============================================================================="
echo: 
call :_color2 %_White% "   " %_Green% "Selection [1,2,3,4,5,0] > "
choice /C:123450 /N
set _erl=%errorlevel%
...
echo:
call :_color %_Cyan% " Creating backup of Registry..."
...
echo %line%
echo:
echo      Note: Activation may not work for all users.
echo:
...
echo:
call :_color %_Cyan% " Creating backup of CLSID registry keys..."
